...
function LoginContent() {
  ...
  async function onSubmit(data: LoginFormValues) {
    ...
    router.push(redirectParams || '/wallet')
    router.refresh()
  }
  ...
  return (
    <div className="pf-card p-8">
      <div className="flex flex-col space-y-2 text-center mb-8">
        <h1 className="pf-headline text-2xl font-semibold tracking-tight">Bienvenido de vuelta</h1>
        <p className="text-sm text-pf-on-surface-var">Ingresa tus datos para continuar a tu wallet.</p>
      </div>
            ...
            <div className="grid gap-2">
              <div className="flex items-center justify-between">
                ...
                <Link
                  ...
                  className="text-sm font-medium text-pf-primary hover:underline"
                >
      ...
      <p className="px-8 text-center text-sm text-pf-on-surface-var mt-8">
        ...
        <Link href={`/registro${redirectParams ? `?redirect=${redirectParams}` : ''}`} className="text-pf-primary hover:underline underline-offset-4">
          Regístrate gratis
        </Link>
      </p>
    </div>
